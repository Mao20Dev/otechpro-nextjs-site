...
export default function LampDemo() {
  return (
    <LampContainer>
      ...
      >
        Bienvenido a Otechpro ! <br /> 
        Gestiona tus proyectos de manera eficiente
        <br /><br /> <Link href="/dashboard">
                                                <button className="bg-button-blue-gradient hover:bg-button-blue-gradient-hover text-slate-200 text-lg font-bold py-2 px-8 rounded">
                                                  Ir al Dashboard
                                                </button>
                                              </Link>
      </motion.h1>
